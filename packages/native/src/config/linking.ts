...
export const linkingConfig = {
  ...
  screens: {
    ...
    [SCREENS.SEARCH.CENTRAL_PANE]: {
      ...
      parse: {
        isCustomQuery: (isCustomQuery: any) =>
          isCustomQuery.toLowerCase() === 'true',
      },
    },
    ...
    [NAVIGATORS.RIGHT_MODAL_NAVIGATOR]: {
      screens: {
        [SCREENS.RIGHT_MODAL.SETTINGS]: {
          screens: {
            ...
            [SCREENS.SETTINGS.WALLET.CARDS_DIGITAL_DETAILS_UPDATE_ADDRESS]: {
              path: ROUTES.SETTINGS_WALLET_CARD_DIGITAL_DETAILS_UPDATE_ADDRESS
                .route,
              exact: true,
            },
            ...
            [SCREENS.WORKSPACE.ACCOUNTING.QUICKBOOKS_ONLINE_CHART_OF_ACCOUNTS]:
              {
                path: ROUTES
                  .POLICY_ACCOUNTING_QUICKBOOKS_ONLINE_CHART_OF_ACCOUNTS.route,
              },
            ...
            [SCREENS.WORKSPACE.ACCOUNTING.QUICKBOOKS_ONLINE_EXPORT]: {
              path: ROUTES.POLICY_ACCOUNTING_QUICKBOOKS_ONLINE_EXPORT.route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING.QUICKBOOKS_ONLINE_EXPORT_DATE_SELECT]:
              {
                path: ROUTES
                  .POLICY_ACCOUNTING_QUICKBOOKS_ONLINE_EXPORT_DATE_SELECT.route,
              },
            [SCREENS.WORKSPACE.ACCOUNTING
              .QUICKBOOKS_ONLINE_EXPORT_INVOICE_ACCOUNT_SELECT]: {
              path: ROUTES
                .POLICY_ACCOUNTING_QUICKBOOKS_ONLINE_INVOICE_ACCOUNT_SELECT
                .route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING
              .QUICKBOOKS_ONLINE_EXPORT_OUT_OF_POCKET_EXPENSES_ACCOUNT_SELECT]:
              {
                path: ROUTES
            ...
            [SCREENS.WORKSPACE.ACCOUNTING
              .QUICKBOOKS_ONLINE_EXPORT_OUT_OF_POCKET_EXPENSES_SELECT]: {
              path: ROUTES
            ...
            [SCREENS.WORKSPACE.ACCOUNTING
              .QUICKBOOKS_ONLINE_EXPORT_PREFERRED_EXPORTER]: {
              path: ROUTES
                .POLICY_ACCOUNTING_QUICKBOOKS_ONLINE_PREFERRED_EXPORTER.route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING.QUICKBOOKS_ONLINE_ADVANCED]: {
              path: ROUTES.WORKSPACE_ACCOUNTING_QUICKBOOKS_ONLINE_ADVANCED
                .route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING.QUICKBOOKS_ONLINE_ACCOUNT_SELECTOR]: {
              path: ROUTES
                .WORKSPACE_ACCOUNTING_QUICKBOOKS_ONLINE_ACCOUNT_SELECTOR.route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING
            ...
            [SCREENS.WORKSPACE.ACCOUNTING.XERO_EXPORT]: {
              path: ROUTES.POLICY_ACCOUNTING_XERO_EXPORT.route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING
              .XERO_EXPORT_PURCHASE_BILL_DATE_SELECT]: {
              path: ROUTES
                .POLICY_ACCOUNTING_XERO_EXPORT_PURCHASE_BILL_DATE_SELECT.route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING.XERO_EXPORT_BANK_ACCOUNT_SELECT]: {
              path: ROUTES.POLICY_ACCOUNTING_XERO_EXPORT_BANK_ACCOUNT_SELECT
                .route,
            },
            ...
            [SCREENS.WORKSPACE.ACCOUNTING.XERO_BILL_STATUS_SELECTOR]: {
              path: ROUTES.POLICY_ACCOUNTING_XERO_BILL_STATUS_SELECTOR.route,
            },
            ...
            [SCREENS.WORKSPACE.ACCOUNTING
              ...
              path: ROUTES.POLICY_ACCOUNTING_XERO_PREFERRED_EXPORTER_SELECT
                .route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING.XERO_BILL_PAYMENT_ACCOUNT_SELECTOR]: {
              path: ROUTES.POLICY_ACCOUNTING_XERO_BILL_PAYMENT_ACCOUNT_SELECTOR
                .route,
            },
            ...
            [SCREENS.WORKSPACE.ACCOUNTING.NETSUITE_REUSE_EXISTING_CONNECTIONS]:
              {
                path: ROUTES.POLICY_ACCOUNTING_NETSUITE_EXISTING_CONNECTIONS
                  .route,
              },
            ...
            [SCREENS.WORKSPACE.ACCOUNTING.NETSUITE_IMPORT_CUSTOM_FIELD]: {
              path: ROUTES
                .POLICY_ACCOUNTING_NETSUITE_IMPORT_CUSTOM_FIELD_MAPPING.route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING.NETSUITE_IMPORT_CUSTOM_FIELD_VIEW]: {
              path: ROUTES.POLICY_ACCOUNTING_NETSUITE_IMPORT_CUSTOM_FIELD_VIEW
                .route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING.NETSUITE_IMPORT_CUSTOM_FIELD_EDIT]: {
              path: ROUTES.POLICY_ACCOUNTING_NETSUITE_IMPORT_CUSTOM_FIELD_EDIT
                .route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING.NETSUITE_IMPORT_CUSTOM_LIST_ADD]: {
              path: ROUTES.POLICY_ACCOUNTING_NETSUITE_IMPORT_CUSTOM_LIST_ADD
                .route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING.NETSUITE_IMPORT_CUSTOM_SEGMENT_ADD]: {
              path: ROUTES.POLICY_ACCOUNTING_NETSUITE_IMPORT_CUSTOM_SEGMENT_ADD
                .route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING
              .NETSUITE_IMPORT_CUSTOMERS_OR_PROJECTS]: {
              path: ROUTES
                .POLICY_ACCOUNTING_NETSUITE_IMPORT_CUSTOMERS_OR_PROJECTS.route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING
              .NETSUITE_IMPORT_CUSTOMERS_OR_PROJECTS_SELECT]: {
              path: ROUTES
            ...
            [SCREENS.WORKSPACE.ACCOUNTING.NETSUITE_PREFERRED_EXPORTER_SELECT]: {
              path: ROUTES.POLICY_ACCOUNTING_NETSUITE_PREFERRED_EXPORTER_SELECT
                .route,
            },
            ...
            [SCREENS.WORKSPACE.ACCOUNTING
              .NETSUITE_EXPORT_EXPENSES_DESTINATION_SELECT]: {
              path: ROUTES
            ...
            [SCREENS.WORKSPACE.ACCOUNTING
              ...
              path: ROUTES
                .POLICY_ACCOUNTING_NETSUITE_EXPORT_EXPENSES_VENDOR_SELECT.route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING
              .NETSUITE_EXPORT_EXPENSES_PAYABLE_ACCOUNT_SELECT]: {
              path: ROUTES
                .POLICY_ACCOUNTING_NETSUITE_EXPORT_EXPENSES_PAYABLE_ACCOUNT_SELECT
                .route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING
              .NETSUITE_EXPORT_EXPENSES_JOURNAL_POSTING_PREFERENCE_SELECT]: {
              path: ROUTES
            ...
            [SCREENS.WORKSPACE.ACCOUNTING.NETSUITE_RECEIVABLE_ACCOUNT_SELECT]: {
              path: ROUTES.POLICY_ACCOUNTING_NETSUITE_RECEIVABLE_ACCOUNT_SELECT
                .route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING
              .NETSUITE_INVOICE_ITEM_PREFERENCE_SELECT]: {
              path: ROUTES
            ...
            [SCREENS.WORKSPACE.ACCOUNTING.NETSUITE_TAX_POSTING_ACCOUNT_SELECT]:
              {
                path: ROUTES
                  .POLICY_ACCOUNTING_NETSUITE_TAX_POSTING_ACCOUNT_SELECT.route,
              },
            [SCREENS.WORKSPACE.ACCOUNTING
            ...
            [SCREENS.WORKSPACE.ACCOUNTING
              .NETSUITE_REIMBURSEMENT_ACCOUNT_SELECT]: {
              path: ROUTES
                .POLICY_ACCOUNTING_NETSUITE_REIMBURSEMENT_ACCOUNT_SELECT.route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING.NETSUITE_COLLECTION_ACCOUNT_SELECT]: {
              path: ROUTES.POLICY_ACCOUNTING_NETSUITE_COLLECTION_ACCOUNT_SELECT
                .route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING
              .NETSUITE_EXPENSE_REPORT_APPROVAL_LEVEL_SELECT]: {
              path: ROUTES
                .POLICY_ACCOUNTING_NETSUITE_EXPENSE_REPORT_APPROVAL_LEVEL_SELECT
                .route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING
              .NETSUITE_VENDOR_BILL_APPROVAL_LEVEL_SELECT]: {
              path: ROUTES
                .POLICY_ACCOUNTING_NETSUITE_VENDOR_BILL_APPROVAL_LEVEL_SELECT
                .route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING
              .NETSUITE_JOURNAL_ENTRY_APPROVAL_LEVEL_SELECT]: {
              path: ROUTES
                .POLICY_ACCOUNTING_NETSUITE_JOURNAL_ENTRY_APPROVAL_LEVEL_SELECT
                .route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING.NETSUITE_APPROVAL_ACCOUNT_SELECT]: {
              path: ROUTES.POLICY_ACCOUNTING_NETSUITE_APPROVAL_ACCOUNT_SELECT
                .route,
            },
            ...
            [SCREENS.WORKSPACE.ACCOUNTING.SAGE_INTACCT_PREREQUISITES]: {
              path: ROUTES.POLICY_ACCOUNTING_SAGE_INTACCT_PREREQUISITES.route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING.ENTER_SAGE_INTACCT_CREDENTIALS]: {
              path: ROUTES.POLICY_ACCOUNTING_SAGE_INTACCT_ENTER_CREDENTIALS
                .route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING.EXISTING_SAGE_INTACCT_CONNECTIONS]: {
              path: ROUTES.POLICY_ACCOUNTING_SAGE_INTACCT_EXISTING_CONNECTIONS
                .route,
            },
            ...
            [SCREENS.WORKSPACE.ACCOUNTING.SAGE_INTACCT_ADD_USER_DIMENSION]: {
              path: ROUTES.POLICY_ACCOUNTING_SAGE_INTACCT_ADD_USER_DIMENSION
                .route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING.SAGE_INTACCT_EDIT_USER_DIMENSION]: {
              path: ROUTES.POLICY_ACCOUNTING_SAGE_INTACCT_EDIT_USER_DIMENSION
                .route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING.SAGE_INTACCT_EXPORT]: {
              path: ROUTES.POLICY_ACCOUNTING_SAGE_INTACCT_EXPORT.route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING.SAGE_INTACCT_PREFERRED_EXPORTER]: {
              path: ROUTES.POLICY_ACCOUNTING_SAGE_INTACCT_PREFERRED_EXPORTER
                .route,
            },
            ...
            [SCREENS.WORKSPACE.ACCOUNTING.SAGE_INTACCT_REIMBURSABLE_EXPENSES]: {
              path: ROUTES.POLICY_ACCOUNTING_SAGE_INTACCT_REIMBURSABLE_EXPENSES
                .route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING
              .SAGE_INTACCT_NON_REIMBURSABLE_EXPENSES]: {
              path: ROUTES
                .POLICY_ACCOUNTING_SAGE_INTACCT_NON_REIMBURSABLE_EXPENSES.route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING.SAGE_INTACCT_DEFAULT_VENDOR]: {
              path: ROUTES.POLICY_ACCOUNTING_SAGE_INTACCT_DEFAULT_VENDOR.route,
            },
            [SCREENS.WORKSPACE.ACCOUNTING
              .SAGE_INTACCT_NON_REIMBURSABLE_CREDIT_CARD_ACCOUNT]: {
              path: ROUTES
            ...
            [SCREENS.WORKSPACE.ACCOUNTING.RECONCILIATION_ACCOUNT_SETTINGS]: {
              path: ROUTES.WORKSPACE_ACCOUNTING_RECONCILIATION_ACCOUNT_SETTINGS
                .route,
            },
            ...
            [SCREENS.WORKSPACE.WORKFLOWS_AUTO_REPORTING_MONTHLY_OFFSET]: {
              path: ROUTES.WORKSPACE_WORKFLOWS_AUTOREPORTING_MONTHLY_OFFSET
                .route,
            },
            ...
            [SCREENS.WORKSPACE.WORKFLOWS_APPROVALS_EDIT]: {
              ...
              parse: {
                firstApproverEmail: (firstApproverEmail: string) =>
                  decodeURIComponent(firstApproverEmail),
              },
            },
            ...
            [SCREENS.WORKSPACE.UPGRADE]: {
              ...
              parse: {
                featureName: (featureName: string) =>
                  decodeURIComponent(featureName),
              },
            },
            ...
            [SCREENS.WORKSPACE.DISTANCE_RATE_TAX_RECLAIMABLE_ON_EDIT]: {
              path: ROUTES.WORKSPACE_DISTANCE_RATE_TAX_RECLAIMABLE_ON_EDIT
                .route,
            },
            ...
            [SCREENS.WORKSPACE.TAXES_SETTINGS_FOREIGN_CURRENCY_DEFAULT]: {
              path: ROUTES.WORKSPACE_TAXES_SETTINGS_FOREIGN_CURRENCY_DEFAULT
                .route,
            },
            [SCREENS.WORKSPACE.TAXES_SETTINGS_WORKSPACE_CURRENCY_DEFAULT]: {
              path: ROUTES.WORKSPACE_TAXES_SETTINGS_WORKSPACE_CURRENCY_DEFAULT
                .route,
            },
            ...
            [SCREENS.WORKSPACE.REPORT_FIELDS_LIST_VALUES]: {
              ...
              parse: {
                reportFieldID: (reportFieldID: string) =>
                  decodeURIComponent(reportFieldID),
              },
            },
        ...
        [SCREENS.RIGHT_MODAL.REPORT_DETAILS]: {
          screens: {
            ...
            [SCREENS.REPORT_DETAILS.EXPORT]:
              ROUTES.REPORT_WITH_ID_DETAILS_EXPORT.route,
          },
        },
        ...
        [SCREENS.RIGHT_MODAL.NEW_TASK]: {
          screens: {
            ...
            [SCREENS.NEW_TASK.TASK_SHARE_DESTINATION_SELECTOR]:
              ROUTES.NEW_TASK_SHARE_DESTINATION,
        ...
        [SCREENS.RIGHT_MODAL.PARTICIPANTS]: {
          screens: {
            [SCREENS.REPORT_PARTICIPANTS.ROOT]:
              ROUTES.REPORT_PARTICIPANTS.route,
            [SCREENS.REPORT_PARTICIPANTS.INVITE]:
              ROUTES.REPORT_PARTICIPANTS_INVITE.route,
            [SCREENS.REPORT_PARTICIPANTS.DETAILS]:
              ROUTES.REPORT_PARTICIPANTS_DETAILS.route,
            [SCREENS.REPORT_PARTICIPANTS.ROLE]:
              ROUTES.REPORT_PARTICIPANTS_ROLE_SELECTION.route,
          },
        },
        ...
        [SCREENS.RIGHT_MODAL.MONEY_REQUEST]: {
          screens: {
            ...
            [SCREENS.SETTINGS_CATEGORIES.SETTINGS_CATEGORIES_ROOT]:
              ROUTES.SETTINGS_CATEGORIES_ROOT.route,
            [SCREENS.MONEY_REQUEST.STEP_SEND_FROM]:
              ROUTES.MONEY_REQUEST_STEP_SEND_FROM.route,
            [SCREENS.MONEY_REQUEST.STEP_COMPANY_INFO]:
              ROUTES.MONEY_REQUEST_STEP_COMPANY_INFO.route,
            [SCREENS.MONEY_REQUEST.STEP_AMOUNT]:
              ROUTES.MONEY_REQUEST_STEP_AMOUNT.route,
            [SCREENS.MONEY_REQUEST.STEP_CATEGORY]:
              ROUTES.MONEY_REQUEST_STEP_CATEGORY.route,
            [SCREENS.MONEY_REQUEST.STEP_CONFIRMATION]:
              ROUTES.MONEY_REQUEST_STEP_CONFIRMATION.route,
            [SCREENS.MONEY_REQUEST.STEP_CURRENCY]:
              ROUTES.MONEY_REQUEST_STEP_CURRENCY.route,
            [SCREENS.MONEY_REQUEST.STEP_DATE]:
              ROUTES.MONEY_REQUEST_STEP_DATE.route,
            [SCREENS.MONEY_REQUEST.STEP_DESCRIPTION]:
              ROUTES.MONEY_REQUEST_STEP_DESCRIPTION.route,
            [SCREENS.MONEY_REQUEST.STEP_DISTANCE]:
              ROUTES.MONEY_REQUEST_STEP_DISTANCE.route,
            [SCREENS.MONEY_REQUEST.STEP_DISTANCE_RATE]:
              ROUTES.MONEY_REQUEST_STEP_DISTANCE_RATE.route,
            [SCREENS.MONEY_REQUEST.HOLD]:
              ROUTES.MONEY_REQUEST_HOLD_REASON.route,
            [SCREENS.MONEY_REQUEST.STEP_MERCHANT]:
              ROUTES.MONEY_REQUEST_STEP_MERCHANT.route,
            [SCREENS.MONEY_REQUEST.STEP_PARTICIPANTS]:
              ROUTES.MONEY_REQUEST_STEP_PARTICIPANTS.route,
            [SCREENS.MONEY_REQUEST.STEP_SCAN]:
              ROUTES.MONEY_REQUEST_STEP_SCAN.route,
            [SCREENS.MONEY_REQUEST.STEP_TAG]:
              ROUTES.MONEY_REQUEST_STEP_TAG.route,
            [SCREENS.MONEY_REQUEST.STEP_WAYPOINT]:
              ROUTES.MONEY_REQUEST_STEP_WAYPOINT.route,
            [SCREENS.MONEY_REQUEST.STEP_TAX_AMOUNT]:
              ROUTES.MONEY_REQUEST_STEP_TAX_AMOUNT.route,
            [SCREENS.MONEY_REQUEST.STEP_TAX_RATE]:
              ROUTES.MONEY_REQUEST_STEP_TAX_RATE.route,
            [SCREENS.MONEY_REQUEST.STATE_SELECTOR]: {
              path: ROUTES.MONEY_REQUEST_STATE_SELECTOR.route,
              exact: true,
            },
            [SCREENS.MONEY_REQUEST.STEP_SPLIT_PAYER]:
              ROUTES.MONEY_REQUEST_STEP_SPLIT_PAYER.route,
            [SCREENS.IOU_SEND.ENABLE_PAYMENTS]: ROUTES.IOU_SEND_ENABLE_PAYMENTS,
            [SCREENS.IOU_SEND.ADD_BANK_ACCOUNT]:
        ...
        [SCREENS.RIGHT_MODAL.EDIT_REQUEST]: {
          screens: {
            [SCREENS.EDIT_REQUEST.REPORT_FIELD]:
              ROUTES.EDIT_REPORT_FIELD_REQUEST.route,
          },
        },
        ...
        [SCREENS.RIGHT_MODAL.PROCESS_MONEY_REQUEST_HOLD]: {
          screens: {
            [SCREENS.PROCESS_MONEY_REQUEST_HOLD_ROOT]:
              ROUTES.PROCESS_MONEY_REQUEST_HOLD,
          },
        },
