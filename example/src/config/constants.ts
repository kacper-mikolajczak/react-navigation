...
export const SCREENS = {
  ...
  SEARCH: {
    ...
    ADVANCED_FILTERS_EXPENSE_TYPE_RHP:
      'Search_Advanced_Filters_Expense_Type_RHP',
  ...
  SETTINGS: {
    ...
    ADD_PAYMENT_CARD_CHANGE_CURRENCY:
      'Settings_Add_Payment_Card_Change_Currency',
    ...
    SUBSCRIPTION: {
      ...
      REQUEST_EARLY_CANCELLATION:
        'Settings_Subscription_RequestEarlyCancellation',
    },
  },
  SAVE_THE_WORLD: {
  ...
  WORKSPACE: {
    ACCOUNTING: {
      ...
      QUICKBOOKS_ONLINE_CLASSES:
        'Policy_Accounting_Quickbooks_Online_Import_Classes',
      QUICKBOOKS_ONLINE_CUSTOMERS:
        'Policy_Accounting_Quickbooks_Online_Import_Customers',
      QUICKBOOKS_ONLINE_LOCATIONS:
        'Policy_Accounting_Quickbooks_Online_Import_Locations',
      QUICKBOOKS_ONLINE_TAXES:
        'Policy_Accounting_Quickbooks_Online_Import_Taxes',
      ...
      QUICKBOOKS_ONLINE_ADVANCED:
        'Policy_Accounting_Quickbooks_Online_Advanced',
      QUICKBOOKS_ONLINE_ACCOUNT_SELECTOR:
        'Policy_Accounting_Quickbooks_Online_Account_Selector',
      ...
      XERO_MAP_TRACKING_CATEGORY:
        'Policy_Accounting_Xero_Map_Tracking_Category',
      ...
      XERO_EXPORT_BANK_ACCOUNT_SELECT:
        'Policy_Accounting_Xero_Export_Bank_Account_Select',
      NETSUITE_IMPORT_MAPPING: 'Policy_Accounting_NetSuite_Import_Mapping',
      NETSUITE_IMPORT_CUSTOM_FIELD:
        'Policy_Accounting_NetSuite_Import_Custom_Field',
      NETSUITE_IMPORT_CUSTOM_FIELD_VIEW:
        'Policy_Accounting_NetSuite_Import_Custom_Field_View',
      NETSUITE_IMPORT_CUSTOM_FIELD_EDIT:
        'Policy_Accounting_NetSuite_Import_Custom_Field_Edit',
      NETSUITE_IMPORT_CUSTOM_LIST_ADD:
        'Policy_Accounting_NetSuite_Import_Custom_List_Add',
      NETSUITE_IMPORT_CUSTOM_SEGMENT_ADD:
        'Policy_Accounting_NetSuite_Import_Custom_Segment_Add',
      NETSUITE_IMPORT_CUSTOMERS_OR_PROJECTS:
        'Policy_Accounting_NetSuite_Import_CustomersOrProjects',
      NETSUITE_IMPORT_CUSTOMERS_OR_PROJECTS_SELECT:
        'Policy_Accounting_NetSuite_Import_CustomersOrProjects_Select',
      NETSUITE_REUSE_EXISTING_CONNECTIONS:
        'Policy_Accounting_NetSuite_Reuse_Existing_Connections',
      NETSUITE_TOKEN_INPUT: 'Policy_Accounting_NetSuite_Token_Input',
      NETSUITE_SUBSIDIARY_SELECTOR:
      ...
      NETSUITE_PREFERRED_EXPORTER_SELECT:
      ...
      NETSUITE_RECEIVABLE_ACCOUNT_SELECT:
      ...
      NETSUITE_INVOICE_ITEM_SELECT:
        'Policy_Accounting_NetSuite_Invoice_Item_Select',
      NETSUITE_TAX_POSTING_ACCOUNT_SELECT:
      ...
      NETSUITE_COLLECTION_ACCOUNT_SELECT:
      ...
      NETSUITE_APPROVAL_ACCOUNT_SELECT:
      ...
      EXISTING_SAGE_INTACCT_CONNECTIONS:
    ...
    EXPENSIFY_CARD_SETTINGS_FREQUENCY:
      'Workspace_ExpensifyCard_Settings_Frequency',
    ...
    TAXES_SETTINGS_WORKSPACE_CURRENCY_DEFAULT:
      'Workspace_Taxes_Settings_WorkspaceCurrency',
    TAXES_SETTINGS_FOREIGN_CURRENCY_DEFAULT:
      'Workspace_Taxes_Settings_ForeignCurrency',
    ...
    DISTANCE_RATE_TAX_RECLAIMABLE_ON_EDIT:
      'Distance_Rate_Tax_Reclaimable_On_Edit',
